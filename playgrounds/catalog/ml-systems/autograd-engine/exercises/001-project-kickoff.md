# Exercise 001: Autograd Engine First Implementation Lab

Shared concept chapter: [autograd-and-training-loops.md](../../../../../curriculum/concepts/ml-systems/autograd-and-training-loops.md)

## Concept Primer

This first lab turns **Autograd Engine** from a broad project idea into a concrete implementation problem. You are building one narrow mechanism, but you should treat it like production code: name the invariant, make the state explicit, and let the tests describe externally visible behavior.

The implementation target is: Implement scalar reverse-mode autodiff for addition and multiplication.
...
After each public operation, the component must preserve this contract: track operation parents; compute gradients by reverse traversal; support addition. If a later feature makes this invariant harder to maintain, the design should expose that tension instead of hiding it in incidental code.
...
Implement scalar reverse-mode autodiff for addition and multiplication.
...
- track operation parents
- compute gradients by reverse traversal
- support addition
