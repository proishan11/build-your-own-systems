# Exercise 001: Git Merge and Rebase Lab First Implementation Lab

Shared concept chapter: [git-object-model.md](../../../../../curriculum/concepts/developer-tools/git-object-model.md)

## Concept Primer

This first lab turns **Git Merge and Rebase Lab** from a broad project idea into a concrete implementation problem. You are building one narrow mechanism, but you should treat it like production code: name the invariant, make the state explicit, and let the tests describe externally visible behavior.
